    ...
    slot: {
        'weapon': [
            ...
            // TODO/REFACTOR : duplication in below code (all Anima-Touched weapons have the same effect)
            {
                ...
                description: 'This weapon gains more Weapon Power when leveling up.</br>Whenever you hit, you have a 33% chance to deal <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> physical damage. You are healed for 100% of the damage dealt.',
                coefficients: [ 0.5 ],
                stats: [ 'Combat Power' ]
            },
            {
            ...
            },
            {
                ...
                description: 'This weapon gains more Weapon Power when leveling up.</br>Whenever you hit, you have a 15% chance to deal <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> physical damage to your target every second for 5 seconds.',
                coefficients: [ 0.5 ],
                stats: [ 'Combat Power' ]
            },
            {
            ...
            },
            {
                ...
                description: 'This weapon gains more Weapon Power when leveling up.</br>Whenever you heal yourself or an ally, you have a 10% chance to apply a barrier which absorbs 100% of incoming damage and dissipates after absorbing <span id="%id-equipment-bonus1" class="bonus-val heal">%d</span> damage. If a barrier already exists, they are instead healed for <span id="%id-equipment-bonus1" class="bonus-val heal">%d</span>. This effect can only occur once every 5 seconds.',
                coefficients: [ 3.75 ],
                stats: [ 'Healing Power' ]
            },
            {
            ...
            },
            {
                ...
                description: 'This weapon gains more Weapon Power when leveling up.</br>Whenever you hit you have a 25% chance to deal an additional <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> physical damage to the target. The amount of damage dealt increases to <span id="%id-equipment-bonus2" class="bonus-val attack">%d</span> physical damage the second time this effect triggers on the same target. The third time this effect triggers on the same target, the damage dealt is increased to <span id="%id-equipment-bonus3" class="bonus-val attack">%d</span> physical damage and the count of the number of times this effect has triggered is reset.',
            ...
            },
            {
                ...
                description: 'This weapon gains more Weapon Power when leveling up.</br>Whenever you hit you have a 20% chance to deal an additional <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> physical damage to the target and reduce the amount of damage you receive by 7.5% for 6 seconds.',
                coefficients: [ 1.5 ],
                stats: [ 'Combat Power' ],
            },
            {
            ...
            },
            {
                ...
                description: 'This weapon gains more Weapon Power when leveling up.</br>Whenever you hit, you have a 33% chance to hex your target and deal an additional <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span>-<span id="%id-equipment-bonus2" class="bonus-val attack">%d</span> magical damage. The damage dealt increases each time this effect is applied, up to a maximum of 5 times. This effect is guaranteed to trigger on critical hits.</br>When an enemy affected by this hex is defeated, nearby enemies are dealt <span id="%id-equipment-bonus3" class="bonus-val attack">%d</span>-<span id="%id-equipment-bonus4" class="bonus-val attack">%d</span> magical damage, based on the number of times the damaging effect has been applied.',
            ...
            },
            {
                ...
                description: 'Whenever you hit, you have a 20% chance to summon a Revenant who will cast Raven Blade. 15 second cooldown.</br>Raven Blade: An attack that deals <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> physical damage.',
                coefficients: [ 2.25 ],
                stats: [ 'Combat Power' ]
            },
            {
            ...
            },
            {
                ...
                description: 'Using "Mend" reduces your Martyrdom level by 2 and heals you for <span id="%id-equipment-bonus1" class="bonus-val heal">%d</span>. "Sanctuary" and "Convalesce" increase your Martyrdom level by an additional 2.',
                coefficients: [ 0.23 ],
                stats: [ 'Healing Power' ]
            },
            {
            ...
            },
            {
                ...
                description: 'Whenever you deal damage divisible by 8, your Protection is increased by 850 for 4 seconds. Also, whenever you evade an attack, your next Chaos attack deals an additional <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> magical damage.',
                coefficients: [ 1.15 ],
                stats: [ 'Combat Power' ]
            },
            {
            ...
            },
            {
                ...
                description: 'Your Elemental cold abilities reduce your heat level by an additional 15 and cause any targets hit to become frostbitten for 6 seconds. Critically hitting a frostbitten enemy with an Elemental attack deals an additional <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> magical damage.',
                coefficients: [ 3.45 ],
                stats: [ 'Combat Power' ]
            },
            {
            ...
            },
            {
                ...
                type: 'Elementalism',
                name: 'Voltaic Shunt',
                description: 'After naturally dissipating heat for 10 seconds, your next Elemental attack will deal an additional <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> magical damage.',
                coefficients: [ 3.0 ],
                stats: [ 'Combat Power' ]
            },
            {
            ...
            },
            {
                ...
                description: 'Whenever your Fury increases, the amount gained is tallied. Once you have gained 100 Fury, your next Fist Weapon attack within 5 seconds will deal an additional <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> damage.',
                coefficients: [ 6.0 ],
                stats: [ 'Combat Power' ]
            },
            {
            ...
            },
            {
                ...
                description: 'Whenever your damage bonus from a matching set of chambers expires, if you land on another matching set within 3 seconds your next Pistol attack will deal an additional <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> physical damage to the target and nearby enemies.',
                coefficients: [ 0.5 ],
                stats: [ 'Combat Power' ]
            },
            {
            ...
            },
            {
                ...
                description: 'Whenever an attack glances you, your next 3 Shotgun attacks will deal an additional <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> physical damage.',
                coefficients: [ 0.24 ],
                stats: [ 'Combat Power' ]
            },
            {
            ...
            },
            {
                ...
                type: 'Shotgun',
                name: 'SPES-C221',
                description: 'Whenever you spend a Shell, you have a 20% chance to cause your next Shotgun attack to deal an additional <span id="%id-equipment-bonus1" class="bonus-val attack">%d</span> physical damage.',
                coefficients: [ 1.5 ],
                stats: [ 'Combat Power' ]
            },
            {
        ...
        'head': [
            ...
            },
            {
                id: 3,
                name: 'Blood Halo',
                description: 'Whenever you heal the same target 5 times, their Protection is increased by <span class="bonus-val const">510</span> for 3 seconds.'
            },
            {
                id: 4,
                name: 'Ashes of Crushed Cities',
                description: 'Whenever you hit the same enemy 3 times in succession, you deal <span id="head-equipment-bonus1" class="bonus-val attack">%d</span> physical damage.',
                coefficients: [ 0.375 ],
                stats: [ 'Combat Power' ]
            },
            {
                id: 5,
                name: 'Revenant Ashes',
                description: 'Whenever you hit the same enemy 3 times in succession, you deal <span id="head-equipment-bonus1" class="bonus-val attack">%d</span> physical damage to that enemy and other nearby enemies.',
                coefficients: [ 0.1875 ],
                stats: [ 'Combat Power' ]
            },
            {
                ...
                description: 'Whenever you hit the same enemy 6 times in succession, your next damaging Power Ability deals an additional <span id="head-equipment-bonus1" class="bonus-val attack">%d</span> physical damage.',
                coefficients: [ 1.05 ],
                stats: [ 'Combat Power' ]
            },
            {
            ...
            },
            {
                ...
                description: 'Whenever you heal the same target 5 times, they are healed for an additional <span id="head-equipment-bonus1" class="bonus-val heal">%d</span> every second for 3 seconds.',
                coefficients: [ 0.2 ],
                stats: [ 'Healing Power' ]
            },
            {
                ...
                description: 'Whenever you heal the same target 5 times, you heal your entire group for an additional <span id="head-equipment-bonus1" class="bonus-val heal">%d</span>.',
                coefficients: [ 0.375 ],
                stats: [ 'Healing Power' ]
            },
            {
                id: 10,
                name: 'Oni Blood',
                description: 'Whenever you heal the same target 5 times, they gain a leech effect that heals for 10% of their damage dealt for 3 seconds. This effect can heal up to <span id="head-equipment-bonus1" class="bonus-val heal">%d</span> damage before being removed.',
                coefficients: [ 0.811 ],
                stats: [ 'Healing Power' ]
            },
            {
                ...
                description: 'Whenever you are hit 5 times in succession, your Protection is increased by <span class="bonus-val const">640</span> for 3 seconds.'
            },
            {
                id: 12,
                name: 'Cosmic Pigment',
                description: 'Whenever you are hit 5 times in succession, you deal <span id="head-equipment-bonus1" class="bonus-val attack">%d</span> physical damage to nearby enemies. This damage generates a large amount of hate.',
                coefficients: [ 0.40 ],
                stats: [ 'Combat Power' ]
            },
            {
        ...
        'finger': [
            ...
            },
            {
                id: 2,
                name: 'Rurikid Knot',
                description: 'Whenever you purge a beneficial effect from an enemy\'s ability, your Protection is increased by <span class="bonus-val const">1530</span> for 4 seconds.'
            },
            {
                id: 3,
                name: 'Skadi\'s Ring',
            ...
            },
            {
                ...
                description: 'Whenever you attempt to cleanse, your defensive target\'s Protection is increased by <span class="bonus-val const">460</span> for 3 seconds.'
            },
            {
                id: 6,
                name: 'Cold Metal',
        ...
        'neck': [
            ...
            },
            {
                ...
                description: 'Whenever you lose health while below 50% of your maximum health, your Protection is increased by <span class="bonus-val const">875</span> for 5 seconds.'
            },
            {
                id: 3,
            ...
            },
            {
                ...
                description: 'Whenever you hit an enemy who is below 50% of their maximum health, you have a 25% chance to deal an additional <span id="neck-equipment-bonus1" class="bonus-val attack">%d</span> physical damage.',
                coefficients: [ 0.5 ],
                stats: [ 'Combat Power' ]
            },
            {
                id: 5,
                name: 'Egon Pendant',
                description: 'Whenever you hit an enemy who is below 50% of their maximum health, you apply a damage over time effect that deals <span id="neck-equipment-bonus1" class="bonus-val attack">%d</span> physical damage over 5 seconds. Your damage is increased by 4.5% for each enemy affected by this effect.',
                coefficients: [ 0.15 ],
                stats: [ 'Combat Power' ]
            },
            {
                ...
                description: 'This talisman gains more Attack Rating when leveling up.<br/>Whenever you hit an enemy who is below 50% of their maximum health, you have a 33% chance to summon a Spectre who will cast Unravel Soul. 10 second cooldown.<br/>Unravel Soul: An attack that deals <span id="neck-equipment-bonus1" class="bonus-val attack">%d</span> magical damage.',
                coefficients: [ 2.2 ],
                stats: [ 'Combat Power' ]
            },
            {
            ...
            },
            {
                ...
                description: 'Whenever you heal an ally who is below 50% of their maximum health, their Protection is increased by <span class="bonus-val const">875</span> for 3 seconds.'
            },
            {
                id: 9,
                name: 'Vampiric Essence',
                description: 'This talisman gains more Heal Rating when leveling up.<br/>Whenever you heal an ally who is below 50% of their maximum health, their damage is increased by 4.5% and their attacks restore their health up to a maximum of <span id="neck-equipment-bonus1" class="bonus-val heal">%d</span> health restored for 3 seconds. This effect can only be applied once every 10 seconds.',
                coefficients: [ 0.335 ],
                stats: [ 'Healing Power' ]
            },
            {
                ...
                description: 'Whenever you lose health while below 50% of your maximum health, you gain a barrier which absorbs 100 of incoming damage and dissipates after absorbing <span id="neck-equipment-bonus1" class="bonus-val heal">%d</span> damage. This effect can only occur once every 10 seconds.',
                coefficients: [ 1.25 ],
                stats: [ 'Healing Power' ]
            },
            {
        ...
        'wrist': [
            ...
            },
            {
                id: 2,
                name: 'Bone Timepiece',
                description: 'Whenever you heal an ally who does not have any active detrimental effects, you have a 25% chance to restore <span id="wrist-equipment-bonus1" class="bonus-val heal">%d</span> health to that ally.',
                coefficients: [ 0.5 ],
                stats: [ 'Healing Power' ]
            },
            {
                ...
                description: 'Whenever you hit an enemy who is Exposed or Debilitated, you have a 25% chance to deal <span id="wrist-equipment-bonus1" class="bonus-val attack">%d</span> physical damage.',
                coefficients: [ 0.5 ],
                stats: [ 'Combat Power' ]
            },
            {
        ...
        'luck': [
            ...
            },
            {
                ...
                description: 'Whenever you evade an attack or an attack glances you, your Protection is increased by <span class="bonus-val const">705</span> for 5 seconds.'
            },
            {
                id: 3,
                name: 'Gambler\'s Soul',
            ...
            },
            {
                id: 6,
                name: 'Tarot Cards',
                description: 'Whenever you critically heal, your defensive target\'s Protection is increased by <span class="bonus-val const">615</span> for 3 seconds.'
            },
            {
                id: 7,
                name: 'Golden Coin',
        ...
        'waist': [
            ...
            },
            {
                ...
                description: 'Whenever you heal an ally who less than 7 metres away from you, you and your ally gain <span class="bonus-val const">625</span> protection for 3 seconds.'
            },
            {
                id: 9,
                name: 'Grounding Line',
            ...
            },
            {
                id: 13,
                name: 'Pentacle Wrap',
                description: 'Reduces the amount of self-damage dealt by Corruption and Martyrdom by 10%. In addition, once you have lost 10% of your health due to corruption or martyrdom, your next damaging Blood Magic ability will deal an additional <span id="waist-equipment-bonus1" class="bonus-val attack">%d</span> magical damage or your next healing Blood Magic ability will restore an additional <span id="waist-equipment-bonus2" class="bonus-val heal">%d</span> health.',
        ...
        'occult': [
            ...
            },
            {
                id: 7,
                name: 'Whalebone Rune',
                description: 'Whenever you or any of your group members defeat an enemy, your Protection is increased by <span class="bonus-val const">2045</span> for 5 seconds.'
            },
            {
                id: 8,
                name: 'Alloy Heart',
