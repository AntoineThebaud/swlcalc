...
QUnit.test("should set combat power + healing power and affect any talisman and weapon bonuses correctly", function(assert) {
    ...
    assert.equal(swlcalc.gear.slots.waist.equipmentDescription(), "Whenever you activate the Frenzied Wrath or Invigorating Wrath abilities, your next damaging Fist Weapon ability will deal an additional <span id=\"waist-equipment-bonus1\" class=\"bonus-val attack\">834</span> physical damage or your next healing Fist Weapon ability will restore an additional <span id=\"waist-equipment-bonus2\" class=\"bonus-val heal\">519</span> health.");
    $("#weapon2-equipment-id").val("53");
    $("#weapon2-equipment-id").change();
    assert.equal(swlcalc.gear.slots.weapon2.equipmentDescription(), "This weapon gains more Weapon Power when leveling up.<br>Whenever you hit, you have a <span class=\"bonus-val const\">33%</span> chance to hex your target and deal an additional <span id=\"weapon2-equipment-bonus1\" class=\"bonus-val attack\">111</span>-<span id=\"weapon2-equipment-bonus2\" class=\"bonus-val attack\">556</span> magical damage. The damage dealt increases each time this effect is applied, up to a maximum of <span class=\"bonus-val const\">5</span> times. This effect is guaranteed to trigger on critical hits.<br>When an enemy affected by this hex is defeated, nearby enemies are dealt <span id=\"weapon2-equipment-bonus3\" class=\"bonus-val attack\">70</span>-<span id=\"weapon2-equipment-bonus4\" class=\"bonus-val attack\">349</span> magical damage, based on the number of times the damaging effect has been applied.");

    $("#stat-combat-power").html("1000");
    swlcalc.summary.updateDescriptions();
    assert.equal(swlcalc.gear.slots.waist.equipmentDescription(), "Whenever you activate the Frenzied Wrath or Invigorating Wrath abilities, your next damaging Fist Weapon ability will deal an additional <span id=\"waist-equipment-bonus1\" class=\"bonus-val attack\">1125</span> physical damage or your next healing Fist Weapon ability will restore an additional <span id=\"waist-equipment-bonus2\" class=\"bonus-val heal\">519</span> health.");
    ...
    swlcalc.summary.updateDescriptions();
    assert.equal(swlcalc.gear.slots.waist.equipmentDescription(), "Whenever you activate the Frenzied Wrath or Invigorating Wrath abilities, your next damaging Fist Weapon ability will deal an additional <span id=\"waist-equipment-bonus1\" class=\"bonus-val attack\">1125</span> physical damage or your next healing Fist Weapon ability will restore an additional <span id=\"waist-equipment-bonus2\" class=\"bonus-val heal\">1125</span> health.");
    ...
    assert.equal(swlcalc.gear.slots.waist.equipmentDescription(), "Whenever you activate the Frenzied Wrath or Invigorating Wrath abilities, your next damaging Fist Weapon ability will deal an additional <span id=\"waist-equipment-bonus1\" class=\"bonus-val attack\">520</span> physical damage or your next healing Fist Weapon ability will restore an additional <span id=\"waist-equipment-bonus2\" class=\"bonus-val heal\">833</span> health.");
