...
test('should import from hash', 120, function() {
    ...
    equal($('#weapon-power-value').val(), '+1832');
    ...
    equal($('#weapon-glyph-value').val(), '+615');
    ...
    equal($('#weapon2-power-value').val(), '0');
    ...
    equal($('#weapon2-glyph-value').val(), '0');
    ...
    equal($('#head-power-value').val(), '+293');
    ...
    equal($('#head-glyph-value').val(), '+1040');
    ...
    equal($('#ring-power-value').val(), '+1752');
    ...
    equal($('#ring-glyph-value').val(), '+241');
    ...
    equal($('#neck-power-value').val(), '+642');
    ...
    equal($('#luck-power-value').val(), '+428');
    ...
    equal($('#luck-glyph-value').val(), '+546');
    ...
    equal($('#waist-power-value').val(), '+339');
    ...
    equal($('#waist-glyph-value').val(), '+241');
    ...
    equal($('#occult-power-value').val(), '+117');
    ...
    equal($('#occult-glyph-value').val(), '+546');
