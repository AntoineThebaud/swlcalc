...
test('should import from hash', 189, function() {
    ...
    equal($('#weapon-equipment-quality').val(), 'mkIII');
    ...
    equal($('#weapon2-equipment-quality').val(), 'mkII');
    ...
    equal($('#head-equipment-quality').val(), 'luminous');
    ...
    equal($('#wrist-equipment-quality').val(), 'luminous');
...
test('should set default values with an empty hash', 191, function() {
    ...
    equal($('#weapon2-equipment-quality').val(), 'mkI');
