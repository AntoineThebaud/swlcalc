...
QUnit.test("should import from hash", function(assert) {
    ...
    assert.equal($("#weapon-equipment-power-rating").html(), "+1577");
    ...
    assert.equal($("#weapon-glyph-rating").html(), "+329");
    ...
    assert.equal($("#weapon2-equipment-power-rating").html(), "+1809");
    ...
    assert.equal($("#weapon2-glyph-rating").html(), "+491");
    ...
    assert.equal($("#head-equipment-power-rating").html(), "+1113");
    ...
    assert.equal($("#head-glyph-rating").html(), "+580");
    ...
    assert.equal($("#finger-equipment-power-rating").html(), "+314");
    ...
    assert.equal($("#finger-glyph-rating").html(), "+1052");
    ...
    assert.equal($("#neck-equipment-power-rating").html(), "+70");
    ...
    assert.equal($("#neck-glyph-rating").html(), "+339");
    ...
    assert.equal($("#wrist-equipment-power-rating").html(), "+1951");
    ...
    assert.equal($("#wrist-glyph-rating").html(), "+270");
    ...
    assert.equal($("#luck-equipment-power-rating").html(), "+53");
    ...
    assert.equal($("#luck-glyph-rating").html(), "+174");
    ...
    assert.equal($("#waist-equipment-power-rating").html(), "+775");
    ...
    assert.equal($("#waist-glyph-rating").html(), "+560");
    ...
    assert.equal($("#occult-equipment-power-rating").html(), "+112");
    ...
    assert.equal($("#occult-glyph-rating").html(), "+783");
...
QUnit.test("should set default values with an empty hash", function(assert) {
    ...
    assert.equal($("#weapon-equipment-power-rating").html(), "0");
    ...
    assert.equal($("#weapon-glyph-rating").html(), "0");
    ...
    assert.equal($("#weapon2-equipment-power-rating").html(), "0");
    ...
    assert.equal($("#weapon2-glyph-rating").html(), "0");
    ...
    assert.equal($("#head-equipment-power-rating").html(), "0");
    ...
    assert.equal($("#head-glyph-rating").html(), "0");
    ...
    assert.equal($("#finger-equipment-quality").val(), "1");
    assert.equal($("#finger-equipment-level").val(), "20");
    assert.equal($("#finger-equipment-power-rating").html(), "0");
    ...
    assert.equal($("#finger-glyph-rating").html(), "0");
    ...
    assert.equal($("#wrist-equipment-power-rating").html(), "0");
    ...
    assert.equal($("#wrist-glyph-rating").html(), "0");
    ...
    assert.equal($("#luck-equipment-power-rating").html(), "0");
    ...
    assert.equal($("#luck-glyph-rating").html(), "0");
    ...
    assert.equal($("#waist-equipment-power-rating").html(), "0");
    ...
    assert.equal($("#waist-glyph-rating").html(), "0");
    ...
    assert.equal($("#occult-equipment-power-rating").html(), "0");
    ...
    assert.equal($("#occult-glyph-rating").html(), "0");
