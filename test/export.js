...
test('should create slot url for weapon with type', 1, function() {
    ...
    equal(slotUrl, 'weapon=3,1,1,30,2,2,1,1,1,0,20');
});
...
test('should create export url', 1, function() {
    ...
    deepEqual(url, 'weapon=3,1,1,30,2,2,1,1,1,0,20&weapon2=3,2,3,30,2,2,1,1,1,0,20&head=3,1,1,30,4,1,3,1,1,0,20&ring=3,1,1,30,3,5,2,20,1,0,20&neck=3,1,1,30,3,5,2,20,1,0,20&wrist=3,1,1,1,3,5,2,20,1,0,20&luck=3,1,1,1,3,4,2,20,1,0,20&waist=3,1,1,30,3,4,2,20,1,0,20&occult=3,1,1,1,3,4,2,20,1,0,20');
});
...
test('should start export url and set in textfield', 1, function() {
    ...
    equal($('#export-textarea').html(), location.origin + location.pathname + '#weapon=3,1,1,30,2,2,1,1,1,0,20&amp;weapon2=3,2,3,30,2,2,1,1,1,0,20&amp;head=3,1,1,30,4,1,3,1,1,0,20&amp;ring=3,1,1,30,3,5,2,20,1,0,20&amp;neck=3,1,1,30,3,5,2,20,1,0,20&amp;wrist=3,1,1,1,3,5,2,20,1,0,20&amp;luck=3,1,1,1,3,4,2,20,1,0,20&amp;waist=3,1,1,30,3,4,2,20,1,0,20&amp;occult=3,1,1,1,3,4,2,20,1,0,20');
});
