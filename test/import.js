...
QUnit.test("should import URL and set summary and slots", function(assert) {
    ...
    assert.equal($("#weapon-equipment-power-rating").html(), "+1832");
    ...
    assert.equal($("#weapon-glyph-rating").html(), "+85");
    assert.equal($("#weapon-glyph-label").html(), " Critical Rating");
    ...
    assert.equal($("#weapon2-equipment-power-rating").html(), "+1832");
    ...
    assert.equal($("#weapon2-glyph-rating").html(), "+85");
    assert.equal($("#weapon2-glyph-label").html(), " Critical Rating");
    ...
    assert.equal($("#head-equipment-power-rating").html(), "+1070");
    ...
    assert.equal($("#head-glyph-rating").html(), "+488");
    assert.equal($("#head-glyph-label").html(), " Hit Rating");
    ...
    assert.equal($("#finger-equipment-power-rating").html(), "+642");
    ...
    assert.equal($("#finger-glyph-rating").html(), "+381");
    assert.equal($("#finger-glyph-label").html(), " Defense Rating");
    ...
    assert.equal($("#neck-equipment-power-rating").html(), "+642");
    ...
    assert.equal($("#neck-glyph-rating").html(), "+381");
    assert.equal($("#neck-glyph-label").html(), " Defense Rating");
    ...
    assert.equal($("#wrist-equipment-power-rating").html(), "+406");
    ...
    assert.equal($("#wrist-glyph-rating").html(), "+381");
    assert.equal($("#wrist-glyph-label").html(), " Defense Rating");
    ...
    assert.equal($("#luck-equipment-power-rating").html(), "+271");
    ...
    assert.equal($("#luck-glyph-rating").html(), "+381");
    assert.equal($("#luck-glyph-label").html(), " Evade Rating");
    ...
    assert.equal($("#waist-equipment-power-rating").html(), "+428");
    ...
    assert.equal($("#waist-glyph-rating").html(), "+381");
    assert.equal($("#waist-glyph-label").html(), " Evade Rating");
    ...
    assert.equal($("#occult-equipment-power-rating").html(), "+271");
    ...
    assert.equal($("#occult-glyph-rating").html(), "+381");
    assert.equal($("#occult-glyph-label").html(), " Evade Rating");
