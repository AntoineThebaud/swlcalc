...
test('should import URL and set summary and slots', 180, function() {
    ...
    equal($('#weapon-equipment-quality').val(), 'mkI');
    ...
    equal($('#weapon2-equipment-quality').val(), 'mkIII');
