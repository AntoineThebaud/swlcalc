...
QUnit.test("should update any talisman and weapon bonuses correctly", function(assert) {
    ...
    assert.equal(swlcalc.gear.slots.waist.edit.getEquipmentDescription(), "Whenever you activate the Frenzied Wrath or Invigorating Wrath abilities, your next damaging Fist Weapon ability will deal an additional <span id=\"waist-edit-equipment-bonus1\" class=\"bonus-val dps\">727</span> physical damage or your next healing Fist Weapon ability will restore an additional <span id=\"waist-edit-equipment-bonus2\" class=\"bonus-val heal\">174</span> health.");
    $("#weapon2-edit-equipment-id").val("53");
    $("#weapon2-edit-equipment-id").change();
    assert.equal(swlcalc.gear.slots.weapon2.edit.getEquipmentDescription(), "Whenever you hit, you have a <span class=\"bonus-val const\">33%</span> chance to hex your target and deal an additional <span id=\"weapon2-edit-equipment-bonus1\" class=\"bonus-val dps\">97</span>-<span id=\"weapon2-edit-equipment-bonus2\" class=\"bonus-val dps\">485</span> magical damage. The damage dealt increases each time this effect is applied, up to a maximum of <span class=\"bonus-val const\">5</span> times. This effect is guaranteed to trigger on critical hits.<br>When an enemy affected by this hex is defeated, nearby enemies are dealt <span id=\"weapon2-edit-equipment-bonus3\" class=\"bonus-val dps\">61</span>-<span id=\"weapon2-edit-equipment-bonus4\" class=\"bonus-val dps\">304</span> magical damage, based on the number of times the damaging effect has been applied.");

    $("#stat-combat-power").html("1000");
    swlcalc.gear.updateEquipmentsBonuses();
    assert.equal(swlcalc.gear.slots.waist.edit.getEquipmentDescription(), "Whenever you activate the Frenzied Wrath or Invigorating Wrath abilities, your next damaging Fist Weapon ability will deal an additional <span id=\"waist-edit-equipment-bonus1\" class=\"bonus-val dps\">1125</span> physical damage or your next healing Fist Weapon ability will restore an additional <span id=\"waist-edit-equipment-bonus2\" class=\"bonus-val heal\">174</span> health.");
    ...
    swlcalc.gear.updateEquipmentsBonuses();
    assert.equal(swlcalc.gear.slots.waist.edit.getEquipmentDescription(), "Whenever you activate the Frenzied Wrath or Invigorating Wrath abilities, your next damaging Fist Weapon ability will deal an additional <span id=\"waist-edit-equipment-bonus1\" class=\"bonus-val dps\">1125</span> physical damage or your next healing Fist Weapon ability will restore an additional <span id=\"waist-edit-equipment-bonus2\" class=\"bonus-val heal\">1125</span> health.");
});
...
QUnit.test("should update all signets bonuses correctly", function(assert) {
    assert.equal(swlcalc.gear.slots.weapon2.edit.getSignetDescription(), "This weapon deals <span id=\"weapon2-edit-signet-bonus1\" class=\"bonus-val dps\">691</span> additional damage to enemies that are below <span class=\"bonus-val const\">35%</span> health.");
    $("#stat-combat-power").html("1000");
    swlcalc.gear.updateSignetsBonuses();
    assert.equal(swlcalc.gear.slots.weapon2.edit.getSignetDescription(), "This weapon deals <span id=\"weapon2-edit-signet-bonus1\" class=\"bonus-val dps\">1070</span> additional damage to enemies that are below <span class=\"bonus-val const\">35%</span> health.");
});
